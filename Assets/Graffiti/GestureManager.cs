...
namespace HoloToolkit.Unity
{
    ...
    public partial class GestureManager : Singleton<GestureManager>
    {
        ...
        //Custom Properties By HoloKidz
        private bool isDrawing;
        public GameObject mSketchPrefab;
        public TrailRenderer trailRenderer;
        public Sketcher mSketcher;
        bool isEditing = false;
        public List<Sketcher> pastSketches = new List<Sketcher>();
        ...
        public void setEditing (Slider slider)
        {
        ...
        {
            Debug.Log(c);
            mWarehouse.currentColor = c;
            if (c.a == 0) return;
            mSketcher.lr.SetColors(c, c);
        }
